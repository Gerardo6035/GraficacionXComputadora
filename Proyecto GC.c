...
void dibujarEstrellas() {
    ...
    glBegin(GL_POINTS);
        srand(12345);//Semilla fija para que no cambien
        for(int i = 0; i < 200; i++) {
...
//Dibujar dios
void dibujarDios() {
    float tiempo = glutGet(GLUT_ELAPSED_TIME) / 1000.0;
    float pulso = 1.0 + 0.15 * sin(tiempo * 3.0);
    ...
    glPushMatrix();
        ...
        //Emision de luz (para que brille)
        float emision[] = {1.0, 0.8, 0.2, 1.0};
        glMaterialfv(GL_FRONT, GL_EMISSION, emision);
        
        glutSolidSphere(1.2, 30, 30);
        
        //Quitar emision
        float noEmision[] = {0.0, 0.0, 0.0, 1.0};
    ...
    switch(escena) {
        ...
        case MERCURIO_CERCA: {
            ...
            dibujarSuperficiePlaneta(mercurio,
                "Uff! Siento que me estoy derritiendo!",
                "Es el planeta mas cercano al Sol... normal!");
            dibujarNave();
            break;
        }  
        ...
        case JUPITER_CERCA: {   
            ...
            dibujarSuperficiePlaneta(jupiter,
                "Ay! La gravedad me aplasta! Pesoo!",
        ...
        case CASTIGO: {
            ...
            dibujarTexto("Castigo: Viviran en la Tierra PARA SIEMPRE", 180, 520);
            break;
        }
        ...
        case CREDITOS: {
            ...
            dibujarTexto("Gracias por ver nuestra pelicula", 240, 300);
